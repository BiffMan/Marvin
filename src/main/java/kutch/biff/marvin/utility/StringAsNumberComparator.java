...
public class StringAsNumberComparator implements Comparator<String>
{
    ...
    /**
     * Splits strings into parts sorting each instance of a number as a number
     * if there is a matching number in the other String.
     *
     * For example A1B, A2B, A11B, A11B1, A11B2, A11B11 will be sorted in that
     * order instead of alphabetically which will sort A1B and A11B together.
     */
    @Override
